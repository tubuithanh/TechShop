// Bản sao quy tắc kiểm tra của backend (backend/utils/customerValidation.js) để báo lỗi ngay khi khách
// đang nhập. Backend vẫn kiểm tra lại toàn bộ - khi sửa quy tắc, sửa CẢ HAI file cho khớp.
